...
# =-=-=-=-=-=-=-
pep_resource_resolve_hierarchy_post(*OUT){
    writeLine("serverLog","post : " ++ $KVPairs.resc_hier)
}
pep_resource_resolve_hierarchy_pre(*OUT){*OUT="compound_resource_cache_refresh_policy=when_necessary"
    writeLine("serverLog","pre  : " ++ $KVPairs.resc_hier)
}
